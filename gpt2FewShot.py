...
prompts = [
    """Analyze the sentiment of the following texts. Choose one of: Positive, Negative, Neutral. Respond with only one word.

    Text: ""QT @user In the original draft of the 7th book, Remus Lupin survived the Battle of Hogwarts. #HappyBirthdayRemusLupin" "
    Sentiment: Positive

    Text: "@user LIT MY MUM 'Kerry the louboutins I wonder how many Willam owns!!! Look Kerry Warner Wednesday!' "
    Sentiment: Positive

    Text: "So disappointed in wwe summerslam! I want to see john cena wins his 16th title "
    Sentiment: Negative

    Text: "That sucks if you have to take the SATs tomorrow "
    Sentiment: Negative
